...
<template>
    <AdminLayout title="Admin Dashboard">
        <!-- Main content header -->
        <div
            class="flex flex-col items-start justify-between pb-6 space-y-4 border-b lg:items-center lg:space-y-0 lg:flex-row dark:border-gray-600">
            <h1 class="text-2xl font-semibold whitespace-nowrap dark:text-gray-100">
                Dashboard
            </h1>
            <a href="#"
        ...
        <div class="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2 lg:grid-cols-4 dark:text-white">
            <!-- Users chart card --><a href="#"
                class="p-4 transition-shadow border dark:border-gray-600 rounded-lg shadow-sm hover:shadow-lg">
        ...
        <div class="grid grid-cols-1 gap-6 mt-6 lg:grid-cols-2 xl:grid-cols-4">
            <!-- Import data card -->
            <div class="border dark:border-gray-600 rounded-lg shadow-sm">
                <!-- Card header -->
                <div
                    class="flex items-center justify-between px-4 py-2 border-b dark:border-gray-600 dark:text-gray-400">
                ...
                <ul class="px-4 pb-4 space-y-4 divide-y dark:divide-gray-600 dark:text-white">
                    ...
                    <li class="pt-4 text-sm font-medium text-gray-400">
                        <p>
                            Or you can
                            <a href="#" class="font-normal text-blue-500 hover:underline whitespace-nowrap">sync data to
                                your dashboard</a>
            ...
            <!-- Monthly chart card -->
            <div class="border rounded-lg dark:border-gray-600 shadow-sm xl:col-span-3 dark:text-gray-400">
                <!-- Card header -->
        ...
        <h3 class="mt-6 text-xl dark:text-gray-100">Users</h3>
        <div class="flex flex-col mt-6 dark:border dark:border-gray-600">
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <div class="overflow-hidden rounded-md shadow-md">
                        <table class="min-w-full overflow-x-scroll divide-y divide-gray-200 dark:divide-gray-600">
                            ...
                            <TransitionGroup name="users" tag="tbody"
                                class="bg-white divide-y divide-gray-200 dark:divide-gray-600 dark:bg-gray-900">
                                <tr v-for="i in 10" :key="i"
                                    class="transition-all hover:bg-gray-100 hover:shadow-lg dark:hover:bg-gray-800">
